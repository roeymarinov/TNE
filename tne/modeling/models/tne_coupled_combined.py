...
from tne.modeling.span_extractors.combined_span_extractor import CombinedSpanExtractor
from tne.modeling.span_extractors.yake_span_extractor import YakeSpanExtractor
logger = logging.getLogger(__name__)


@Model.register("tne_coupled_combined_model")
class TNECoupledCombinedModel(Model):
    """
    Details
    ...
    def __init__(
        ...
        self._combined_span_extractor = CombinedSpanExtractor(yake_span_extractor, endpoint_span_extractor)
    ...
    def get_span_embeddings(self, text, spans, metadata):
        ...
        # Shape: (batch_size, num_spans, 3 * encoding_dim)
        span_embeddings = self._combined_span_extractor(contextualized_embeddings, spans, metadata)
